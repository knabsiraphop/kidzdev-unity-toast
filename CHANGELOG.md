...
### Added
- PlayMode test coverage (`Burst_FiveShowsAgainstCapacityThree_SettlesAtCap`) proving a burst of `Show()` calls against a lower `maxVisible` correctly settles at the cap once evicted toasts finish their exit transition.
